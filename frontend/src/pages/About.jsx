        ...
        <div className="row g-5 align-items-center">
          <div className="col-lg-6 col-xl-5 wow fadeInLeft" data-wow-delay="0.1s">
            <div className="about-img">
              <img src={"img/"+data.img1} className="img-fluid w-100 rounded-top bg-white" alt="Image" />
              <img src={"img/"+data.img2} className="img-fluid w-100 rounded-bottom" alt="Image" />
            </div>
          </div>
          ...
          <br></br>
            ...
            <div className="row g-4 justify-content-between mb-5">
              <div className="col-lg-6 col-xl-5">
                <p className="text-dark"><i className="fas fa-check-circle text-green me-1" /> {data.checkbox}</p>
                <p className="text-dark mb-0"><i className="fas fa-check-circle text-green me-1" /> {data.checkbox}</p>
              </div>
