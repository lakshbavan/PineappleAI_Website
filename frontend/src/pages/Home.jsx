        ...
        <div className="header-carousel-item">
          ...
          <div className="carousel-caption">
            <div className="carousel-caption-inner text-start p-3">
              <h1 className="display-1 text-capitalize text-white mb-4 fadeInUp animate__animated" style={{ animationDelay: '1.3s' }}>Explore innovative solutions that drive success and set new industry standards.</h1>
        ...
        <div className="header-carousel-item mx-auto">
          ...
          <div className="carousel-caption">
            <div className="carousel-caption-inner text-center p-3">
              <h1 className="display-1 text-capitalize text-white mb-4">The most prestigious Software company worldwide.</h1>
        ...
        {/* <div className="header-carousel-item">
          ...
          <div className="carousel-caption">
            <div className="carousel-caption-inner text-end p-3">
              <h1 className="display-1 text-capitalize text-white mb-4">The most prestigious Investments company worldwide.</h1>
