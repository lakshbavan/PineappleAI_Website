...
function About() {
  ...
  const [data_teams_member, setteams_member] = useState([]);
  const headerOptions = {
    items: 1,
    loop: true,
    autoplay: true,
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:3001/aboutus_team_heading/view')
      .then(result => setteams_header(result.data))
      .catch(err => console.log(err))
          ...
          <nav className="navbar navbar-expand-lg navbar-dark bg-white py-3 px-4">
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
              <div className="navbar-nav ms-auto py-0">
                ...
                <a href="/aboutus" className="nav-item nav-link active">About</a>
          ...
          <div className="row g-5 align-items-center">
            <div className="col-lg-6 col-xl-5 wow fadeInLeft" data-wow-delay="0.1s">
              <div className="about-img">
                <img src={"http://localhost:3001/images/" + data.img1} className="img-fluid w-100 rounded-top bg-white" alt="Image" />
                <img src={"http://localhost:3001/images/" + data.img2} className="img-fluid w-100 rounded-bottom" alt="Image" />
              </div>
            </div>
            <div className="col-lg-6 col-xl-7 wow fadeInRight" data-wow-delay="0.3s">
              ...
              <p className="text ps-4 mb-4">{data.aboutus_des}
              </p>
            ...
            {data_teams_member.map(member => (
              ...
              <div className="team-item rounded">
                <div className="team-img">
                  <img src={"http://localhost:3001/images/" + member.imageUrl} className="img-fluid w-100 rounded-top fixed-size-image" alt="Image" />
                  <div className="team-icon">
                    ...
                    <div className="team-icon-share">
                      <a className="btn btn-primary btn-sm-square text-white rounded-circle mb-3" href={member.socialMedia.sociallist1}><i className="fab fa-facebook-f" /></a><br/>
                      <a className="btn btn-primary btn-sm-square text-white rounded-circle mb-3" href={member.socialMedia.sociallist2}><i className="fab fa-twitter" /></a><br/>
                      <a className="btn btn-primary btn-sm-square text-white rounded-circle mb-0" href={member.socialMedia.sociallist3}><i className="fab fa-instagram" /></a>
                    </div>
                  </div>
                </div>
